<html>
    <head>
        <title>iEvent</title>
        <META HTTP-EQUIV="REFRESH" CONTENT="10;URL=http://www.ievent.esy.es">
        ...
        <script type="text/javascript">
            ...
            function contador() {
                num--;
                if (num == 0)
                    location = 'http://www.ievent.esy.es';
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <a href="http://www.ievent.esy.es">Si no te redirige automaticamente pulse en el enlace</a>
                </div>
            </div>
        </div>
    </body>
